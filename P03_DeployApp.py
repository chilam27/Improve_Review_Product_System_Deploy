...
To see how I deploy the machine learning model onto the internet using [Streamlit](https://streamlit.io/) and [Heroku](https://www.heroku.com/), check out my ["Improve_Review_System_Deploy"](https://github.com/chilam27/Improve_Review_Product_System_Deploy) repository for the code and data files.
""")
st.write('---')
