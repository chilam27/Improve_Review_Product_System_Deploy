...
st.write("The sample size for the training model is: 1600")
...
def user_input_features():
    ...
    # Input Text
    user_input_head = "comfortable" #st.text_input("Product Review Header:", "Header")
    user_input_cmt = "comfortable heavy like denim great work pant comfortable well make get many year service pant tough condition go wrong dicky" #st.text_input("Product Review Comment:", "Comment")
